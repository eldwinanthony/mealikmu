...
class ProfileViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        profileUIView.layer.shadowOpacity = 0.5
        profileUIView.layer.shadowOffset = .zero
        profileUIView.layer.shadowRadius = 10
        ...
        preptimeTextField.layer.shadowRadius = 6
        ...
        mealtime1TextField.layer.shadowRadius = 6
        ...
        mealtime2TextField.layer.shadowRadius = 6
        ...
        mealtime3TextField.layer.shadowRadius = 6
